/* flasher */
let about_book = `Join Marmalade, an adventurous little mouse, as she sets off
					...
					Dive into this enchanting tale to find out!`;
let about_author = `The author of \"The Incredible Journey of Marmalade the Mouse\" 
